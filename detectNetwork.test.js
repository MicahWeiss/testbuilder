  ...
  for (var prefix = 644; prefix <= 649; prefix++) {
    (function (prefix) {
      it('has a prefix of ' + prefix + ' and a length of 16', function() {
        card = prefix + '1234567890123';
        detectNetwork(card).should.equal('Discover')
      });
      it('has a prefix of ' + prefix + ' and a length of 19', function() {
        card = prefix + '1234567890123456';
        detectNetwork(card).should.equal('Discover')
      });
    })(prefix);
  }
    ...
    for(var k = 12; k <= 19; k++){
      (function(prefix, pad){
        it('has a prefix of ' + prefix + ' and a length of' + k, function(){
          detectNetwork(prefix + pad).should.equal('Maestro');
        });
      })(prefix, pad);
      pad = pad + '1';
    }
...
describe('China UnionPay', function(){
  ...
  for(var prefix = 622126; prefix <= 622925; prefix++){
    (function (prefix) {
      it('has a prefix of ' + prefix + ' and a length of 16', function() {
        card = prefix + '1234567890';
        //console.log('Is China UnionPay?', card, detectNetwork(card) === 'China UnionPay' )
        detectNetwork(card).should.equal('China UnionPay')
      });
      it('has a prefix of ' + prefix + ' and a length of 17', function() {
        card = prefix + '12345678901';
        detectNetwork(card).should.equal('China UnionPay')
      });
      it('has a prefix of ' + prefix + ' and a length of 18', function() {
        card = prefix + '123456789012';
        detectNetwork(card).should.equal('China UnionPay')
      });
      it('has a prefix of ' + prefix + ' and a length of 19', function() {
        card = prefix + '1234567890123';
  ...
  for(var prefix = 624; prefix <= 626; prefix++){
    (function (prefix) {
      ...
      it('has a prefix of ' + prefix + ' and a length of 17', function() {
        card = prefix + '12345678901234';
        detectNetwork(card).should.equal('China UnionPay')
      });
      it('has a prefix of ' + prefix + ' and a length of 18', function() {
        card = prefix + '123456789012345';
        detectNetwork(card).should.equal('China UnionPay')
      });
      it('has a prefix of ' + prefix + ' and a length of 19', function() {
        card = prefix + '1234567890123456';
...
describe('Switch', function(){
  ...
  var prefixList = ['4903', '4905', '4911', '4911', '4936', '6333', '6759'] // 4 digit prefixes
  var prefix; 
  for (var i=0; i < prefixList.length; i++) {
    prefix = prefixList[i];
    (function (prefix) {
  ...
  prefixList = ['564182', '633110']; //6 digits
  for (var i=0; i < prefixList.length; i++) {
    prefix = prefixList[i];
    (function (prefix) {
      it('has a prefix of ' + prefix + ' and a length of 16', function() {
